...
class RoomsController < ApplicationController
  ...
  def create
    ...
    @room.room_settings = create_room_settings_string(params[:room])
  ...
  def start
    ...
    opts[:upload_file] = my_room_settings["uploadFile"]
 ...
 # POST /:room_uid/update_settings
  ...
  def room_params
    params.require(:room).permit(:name, :auto_join, :mute_on_join, :access_code,
      :require_moderator_approval, :anyone_can_start, :all_join_moderator, :allow_recording, :recording, :presentation)
  end
